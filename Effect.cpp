...
255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 3, 255, 42, 255, 14, 255, 29, 255, 255, 28, 255, 255, 10, 255, 255, 57, 11, 255, 43, 255, 41, 255, 255, 255, 55, 255, 255, 36, 8, 255, 255, 62, 56, 20, 255, 255, 255, 255, 255, 255, 255, 22, 255, 255, 54, 255, 255, 59, 21, 255, 255, 255, 255, 49, 16, 27, 45, 17, 255, 48, 255, 255, 255, 58, 255, 2, 255, 15, 4, 23, 255, 255, 51, 255, 255, 255, 255, 44, 255, 255, 38, 19, 255, 255, 52, 255, 255, 0, 255, 31, 255, 255, 61, 255, 60, 255, 13, 255, 255, 255, 12, 26, 255, 32, 255, 255, 255, 255, 47, 255, 255, 53, 1, 30, 255, 50, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255 };
...
Effect::Effect(uint16_t slave)
{
   ...
   se_delay[4] = 0xffff;
   if (slave_id < sizeof(e4_delays))
   {
      uint8_t d = pgm_read_byte( &(e4_delays[slave_id]));
      if (d!=0xff)
         se_delay[4] = d * 15;
   }
